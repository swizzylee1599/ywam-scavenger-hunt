(function setupTranslations() {
  const translations = {
    en: {
      ...
      'timer.go': 'Go, go, go!',
      'timer.finalTen': 'Final 10 minutes — finish strong!',
      'timer.finalFive': 'Only 5 minutes left!',
      'timer.finalMinute': 'Final minute — submit now!',
      ...
      'leaderboard.newLeader': 'New leader! {team} has taken first place!',
      'milestone.reached': 'Amazing! Your team reached {count} approved challenges!',
      'milestone.complete': 'Race complete! Your team finished every available challenge!',
      'mystery.remaining': 'Mystery challenge · {minutes} min left',
    ...
    km: {
      ...
      'timer.go': 'ទៅ! ទៅ! ទៅ!',
      'timer.finalTen': 'នៅសល់ ១០ នាទីចុងក្រោយ — ប្រឹងឱ្យអស់ពីសមត្ថភាព!',
      'timer.finalFive': 'នៅសល់តែ ៥ នាទីប៉ុណ្ណោះ!',
      'timer.finalMinute': 'នាទីចុងក្រោយ — សូមដាក់ស្នើឥឡូវនេះ!',
      ...
      'leaderboard.newLeader': 'ក្រុមនាំមុខថ្មី! {team} បានឡើងមកលេខ ១!',
      'milestone.reached': 'អស្ចារ្យ! ក្រុមរបស់អ្នកបានបំពេញ {count} បេសកកម្មដែលបានអនុម័ត!',
      'milestone.complete': 'បានបញ្ចប់ការប្រកួត! ក្រុមរបស់អ្នកបានបំពេញបេសកកម្មទាំងអស់!',
      'mystery.remaining': 'បេសកកម្មអាថ៌កំបាំង · នៅសល់ {minutes} នាទី',
